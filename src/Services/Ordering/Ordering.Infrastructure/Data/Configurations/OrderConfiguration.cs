...
namespace Ordering.Infrastructure.Data.Configurations
{
    public class OrderConfiguration : IEntityTypeConfiguration<Order>
    {
        public void Configure(EntityTypeBuilder<Order> builder)
        {
            ...
            {
                nameBuilder.Property(p => p.Value).HasColumnName(nameof(Order.OrderName)).HasMaxLength(100).IsRequired();
            });
            ...
            builder.Property(o => o.Status).HasDefaultValue(OrderStatus.Pending).IsRequired();
