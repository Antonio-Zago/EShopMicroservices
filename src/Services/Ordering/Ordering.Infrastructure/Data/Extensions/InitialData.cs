    ...
    internal class InitialData
    {
        ...
        public static IEnumerable<Order> OrdersWithItems
        {
            get
            {
                ...
                var address2 = Address.Of("john", "doe", "john@gmail.com", "Broadway No:1", "USA", "New York", "10001");

                var payment1 = Payment.Of("mehmet", "5555555555554444", "12/28", "355", 1);
                var payment2 = Payment.Of("john", "8885555555554444", "06/30", "111", 2);

                var order1 = Order.Create(
                    OrderId.Of(new Guid("5334c996-8457-4cf0-815c-ed2b77c4ff61")),
                ...
                var order2 = Order.Create(
                    OrderId.Of(new Guid("7e4b8a6f-f8e2-4db8-a342-84f0a95b2f3d")),
